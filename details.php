  ...
  <div class="splash-header">
    <div class="container">
      <h2>
        ...
        <br>
        <strong><time datetime="2016-08-27">August 27, 2016</time></strong>
        <small>is the date to be there</small>
      </h2>

      <div class="row">
        <div class="six columns details-column">
          <h3 class="details-title">The Ceremony</h3>
